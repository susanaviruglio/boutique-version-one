...
SECRET_KEY = 'django-insecure-17oc-s-l6k@9yy(mrsw8ut)7b(4h4c_d2%l*l(kv1mck1&@sun'
 
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['8000-susanavirug-boutiquever-b453xi7391g.ws-eu107.gitpod.io']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bag.contexts.bag_contents', # context procesor
            ],
        },
    },
]
